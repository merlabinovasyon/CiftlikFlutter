...
class AddSheepPage extends StatefulWidget {
  const AddSheepPage({super.key});

  @override
  State<AddSheepPage> createState() => _AddSheepPageState();
}

class _AddSheepPageState extends State<AddSheepPage> {
  ...
  final List<String> _sheep = ['Merinos', 'Türk Koyunu', 'Çine Çoban Koyunu'];
        ...
        child: Form(
          ...
          child: ListView(
            children: [
              ...
              SizedBox(height: 16),
              _buildSelectionField('Irk *', _selectedSheep, _sheep, (value) {
                setState(() {
              ...
              SizedBox(height: 16),
              _buildCounterField('Koyun Tipi', _countController),
              SizedBox(height: 16),
              _buildDateField('Koyunun Kayıt Tarihi *', _dobController),
              SizedBox(height: 16),
              _buildTimeField('Koyunun Kayıt Zamanı', _timeController),
              SizedBox(height: 16),
            ],
          ),
        ),
