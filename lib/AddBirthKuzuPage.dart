...
class AddBirthKuzuPage extends StatefulWidget {
  const AddBirthKuzuPage({super.key});

  @override
  State<AddBirthKuzuPage> createState() => _AddBirthKuzuPageState();
}

class _AddBirthKuzuPageState extends State<AddBirthKuzuPage> {
  ...
  String? _selectedKoc;
  String? _selectedLamb;
  String? _selected1Lamb;
  String? _selected2Lamb;
  ...
  final List<String> _koc = ['Koç 1', 'Koç 2', 'Koç 3'];
  final List<String> _lamb = ['Merinos', 'Türk Koyunu', 'Çine Çoban Koyunu'];
  final List<String> _lamb1 = ['Merinos', 'Türk Koyunu', 'Çine Çoban Koyunu'];
        ...
        child: Form(
          ...
          child: ListView(
            children: [
              ...
              SizedBox(height: 16),
              _buildSelectionField('Koçunuz *', _selectedKoc, _koc, (value) {
                setState(() {
                  _selectedKoc = value;
                });
              }),
              ...
              SizedBox(height: 24),
              Text('1. Kuzu', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
              SizedBox(height: 16),
              _buildTextField('Küpe No *', 'GEÇİCİ_NO_16032'),
              SizedBox(height: 16),
              _buildTextField('Devlet Küpe No *', 'GEÇİCİ_NO_16032'),
              SizedBox(height: 16),
              _buildSelectionField('Irk *', _selectedLamb, _lamb, (value) {
                setState(() {
                  _selectedLamb = value;
                });
              }),
              ...
              SizedBox(height: 16),
              _buildCounterField('Kuzu Tipi', _countController),
              SizedBox(height: 24),
              Row(
              ...
              if (_isTwin) ...[
                SizedBox(height: 24),
                Text('2. Kuzu', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                SizedBox(height: 16),
                _buildTextField('Küpe No *', ''),
                SizedBox(height: 16),
                _buildTextField('Devlet Küpe No *', 'GEÇİCİ_NO_16032'),
                SizedBox(height: 16),
                _buildSelectionField('Irk *', _selected1Lamb, _lamb1, (value) {
                  setState(() {
                    _selected1Lamb = value;
                  });
                }),
                SizedBox(height: 16),
                _buildTextField('Hayvan Adı', ''),
                ...
                SizedBox(height: 16),
                _buildCounterField('Kuzu Tipi', _count1Controller),
                SizedBox(height: 24),
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
              ...
              if (_isTriplet) ...[
                SizedBox(height: 24),
                Text('3. Kuzu', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                SizedBox(height: 16),
                _buildTextField('Küpe No *', ''),
                SizedBox(height: 16),
                _buildTextField('Devlet Küpe No *', 'GEÇİCİ_NO_16032'),
                SizedBox(height: 16),
                _buildSelectionField('Irk *', _selected2Lamb, _lamb1, (value) {
                  setState(() {
                    _selected2Lamb = value;
                  });
                }),
                SizedBox(height: 16),
                _buildTextField('Hayvan Adı', ''),
                ...
                SizedBox(height: 16),
                _buildCounterField('Kuzu Tipi', _count2Controller),
              ],
            ],
          ),
        ),
