...
class AddKocPage extends StatefulWidget {
  const AddKocPage({super.key});

  @override
  State<AddKocPage> createState() => _AddKocPageState();
}

class _AddKocPageState extends State<AddKocPage> {
  ...
  String? _selectedKoc;
  final List<String> _koc = ['Merinos', 'Türk Koyunu', 'Çine Çoban Koyunu'];
        ...
        child: Form(
          ...
          child: ListView(
            children: [
              ...
              SizedBox(height: 16),
              _buildSelectionField('Irk *', _selectedKoc, _koc, (value) {
                setState(() {
                  _selectedKoc = value;
                });
              }),
              ...
              SizedBox(height: 16),
              _buildCounterField('Koç Tipi', _countController),
              SizedBox(height: 16),
              _buildDateField('Koçun Kayıt Tarihi *', _dobController),
              SizedBox(height: 16),
              _buildTimeField('Koçun Kayıt Zamanı', _timeController),
              SizedBox(height: 16),
            ],
          ),
        ),
