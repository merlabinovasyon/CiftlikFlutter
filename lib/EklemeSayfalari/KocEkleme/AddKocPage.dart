        ...
        child: Form(
          ...
          child: ListView(
            children: [
              ...
              const SizedBox(height: 16),
              BuildCounterField(label: 'Koç Tipi', controller: controller.countController, title: 'koç'),
              const SizedBox(height: 16),
              BuildDateField(label: 'Koçun Kayıt Tarihi *', controller: controller.dobController),
              const SizedBox(height: 16),
              BuildTimeField(label: 'Koçun Kayıt Zamanı', controller: controller.timeController, onTap: utils.showTimePicker),
              SizedBox(height: 16),
              Padding(
