...
import 'NotificationDenemeController.dart';

class NotificationDenemePage extends StatelessWidget {
  final NotificationDenemeController controller = Get.put(NotificationDenemeController());
